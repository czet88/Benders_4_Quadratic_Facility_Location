...
void initialize_memory(void) {
  ...
  initial_cuts = (INCUTS*)calloc(1, sizeof(INCUTS));
  initial_cuts[0].sense = (char*)calloc(1, sizeof(char));
  initial_cuts[0].rhs = create_double_vector(1);
  initial_cuts[0].beg = create_int_vector(1);
  initial_cuts[0].ind = create_int_vector(NN * NN + 1);
  initial_cuts[0].val = create_double_vector(NN * NN + 1);
  initial_cuts[0].origval = create_double_vector(NN * NN);
